const divSelectRomm = document.getElementById("selectRoom");
const divConsultingRomm = document.getElementById("consultingRoom");
...
btnGoRoom.addEventListener("click",function(){
  if(inputRoomNumber.value === ""){
    ...
    divSelectRomm.style.display = "none";
    divConsultingRomm.style.display = "block";
  }
})
